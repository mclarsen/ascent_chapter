...
adds when translating actions, while other actions add more than one fitler to the graph.
%
Figure~\ref{img:flow_graph} shows a simplified view of a data-flow network constructed by the
...
provided by Ascent.
%
Just like internal filters, custom filters can either be registerd as transforms or extracts,
