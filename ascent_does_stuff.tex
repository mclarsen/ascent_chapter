...
and radiograph plots.  \fix{Matt: can we get a picture of these four in a 2x2 layout?  The tutorial has pseudocolor,volume,mesh, but not radiograph.}
%
...
or \fix{even a combination of multiple pipelines and simulation data}.
%
