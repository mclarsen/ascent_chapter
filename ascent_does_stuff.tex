...
Finally, Figure~\ref{fig:interactions} shows simulation data as only being at the tail of arrows,
and never the head, i.e., nothing is ever sent to the simulation.
%
