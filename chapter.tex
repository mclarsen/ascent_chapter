...
\abstract{
This chapter describes the Ascent library for in situ visualization and analysis.
%
The chapter begins by describing the library's focal points:
minimizing encumbrance on simulation codes, enabling diverse
and powerful capabilities, exascale architectures, and delivering a product.
%
It then describes Ascent's abstractions, design, and interface.
%
The chapter concludes with success stories that demonstrate its
capabilities:
...
%
Further,  while not a focus of this chapter, Ascent is built for production use by computational
...
%
Ascent has far fewer dependencies that more mature community visualization tools.
