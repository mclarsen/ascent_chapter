...
%
\fix{ALT: Ascent has far fewer dependencies that more mature community visualization tools.
...
\fix{Ascent takes multiple approaches to deliver diverse and powerful capabilities:
